...
export default function HomeBottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-1/2 z-50 grid w-full max-w-[480px] -translate-x-1/2 grid-cols-4 rounded-t-[22px] border border-[#e9e4dd] bg-white px-4 pb-5 pt-3 shadow-[0_-10px_24px_rgba(76,55,30,0.1)] max-[480px]:rounded-t-[18px] max-[480px]:px-2 max-[480px]:pb-[max(0.5rem,env(safe-area-inset-bottom))] max-[480px]:pt-2">
      <button
        onClick={() => {
          router.push('/');
        }}
